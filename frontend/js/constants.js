const contractAddress = "0x88dd538A9D162c928332e54B6B22525F42bF8AB0"; // Replace with your own contract address
...
const p_public_mint = "No whitelist needed.";
const button_presale_coming_soon = "Get on the Whitelist";
const button_presale_mint_whitelisted = "Mint Your Special BEAST";
const button_presale_mint_not_whitelisted = "Get on the Whitelist";
const button_presale_already_minted = "Join the Beastmmunity";
const button_public_mint = "Mint Your BEASTS here";
const mint_failed = "Your minting failed. Please try again.";
